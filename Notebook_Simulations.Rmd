...
If clones appear uniformly, then we can rank the ages at onset and, if their distances to the previous age at onset are uniformly distributed, assess this uniformity using a simple chi-squared test.
