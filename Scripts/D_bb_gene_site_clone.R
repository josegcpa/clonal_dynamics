...
b_gene_sd <- sqrt(1/gamma(
  sd_epsilon,1/sd_epsilon,dim = c(1,length(gene_list))))
b_gene_mean <- normal(b_gene_mean_mean,
                      b_gene_mean_sd,
...
b_site_sd <- sqrt(1/gamma(
  sd_epsilon,1/sd_epsilon,dim = c(1,length(site_list))))
b_site_mean <- normal(b_site_mean_mean,
                      b_site_mean_sd,
